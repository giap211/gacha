...
const Main = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://gacha-nu.vercel.app/banners/", { cancelToken: source.token })
      .then((response) => {
  ...
  useEffect(() => {
    const source = axios.CancelToken.source();
    axios
      .get("https://gacha-nu.vercel.app/characters/", { cancelToken: source.token })
      .then((response) => {
  ...
  useEffect(() => {
    const source = axios.CancelToken.source();
    axios
      .get("https://gacha-nu.vercel.app/weapons/", { cancelToken: source.token })
      .then((response) => {
  ...
  useEffect(() => {
    const source = axios.CancelToken.source();
    axios
      .get("https://gacha-nu.vercel.app/types/", { cancelToken: source.token })
      .then((response) => {
